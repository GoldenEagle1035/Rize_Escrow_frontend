...
//
export interface SectionVoting3Props { }

const SectionVoting3: FC<SectionVoting3Props> = () => {

  const [open_post, setOpenPost] = useState("open");

  return (
    <div className="nc-SectionVoting3 relative">
      <div className="flex flex-col p-12">
        <div className="flex justify-center">
          <p className="text-[16px] leading-[14px] text-white font-[100] text-justify">
            Vote begins at 2 million Coreum staked
          </p>
        </div>
        <div className="flex justify-center py-12">
          <p className="text-[48px] leading-[48px] text-[#33FF00] font-[100] text-justify">
            0.01 mil
          </p>
        </div>
        ...
        <div className="flex mt-6">
          <p className="text-[30px] leading-[30px] text-[#33FF00] font-[100] text-justify">
            Open Votes : 3
          </p>
        </div>
